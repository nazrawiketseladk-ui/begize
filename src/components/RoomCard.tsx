...
export const RoomCard: React.FC<RoomCardProps> = ({
  ...
  return (
    <div className="fintech-card p-5 flex flex-col justify-between transition-all duration-200 border-black/5 dark:border-white/15">
      ...
      {/* Action Buttons Bar */}
      <div className="grid grid-cols-2 gap-2 pt-4 mt-3 border-t border-black/5 dark:border-white/10">
        
        {/* SMS Reminder Template Preview */}
        <button
          onClick={() => onOpenSMSModal(room)}
          className="flex items-center justify-center gap-1.5 py-2 px-2 rounded-xl text-xs font-bold bg-blue-50 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300 hover:bg-blue-100 dark:hover:bg-blue-500/30 border border-blue-200 dark:border-blue-500/30 transition-colors"
        ...
        <button
          ...
          className="flex items-center justify-center gap-1.5 py-2 px-2 rounded-xl text-xs font-semibold bg-zinc-100 dark:bg-white/10 text-zinc-800 dark:text-white hover:bg-zinc-200 dark:hover:bg-white/20 border border-black/5 dark:border-white/10 transition-colors"
        >
